	...
	*/
	...
	private void readAndDrawGraph() {
		...
		try {
			...
			indata = new Scanner(new File("C:/Users/Joakim/Documents/Github/datastrukturer/lab3/out/production/lab3/stops.noBOM.txt"), "UTF-8");
			//indata = new Scanner(new File("/Users/TiM/Developer/IdeaProjects/Datastrukt/datastrukturer/lab3/out/production/lab3/production/lab3/stops.noBOM.txt"), "UTF-8");
			...
			indata =  new Scanner(new File("C:/Users/Joakim/Documents/Github/datastrukturer/lab3/out/production/lab3/lines.noBOM.txt"), "UTF-8");
			//indata =  new Scanner(new File("/Users/TiM/Developer/IdeaProjects/Datastrukt/datastrukturer/lab3/out/production/lab3/production/lab3/lines.noBOM.txt"), "UTF-8");
